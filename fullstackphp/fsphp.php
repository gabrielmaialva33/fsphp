...
/**
 * Meu estudo do PHP
 * @author Gabriel Maia <https://github.com/gabrielmaialva33>
 *
...
"<link rel='icon' href='http://localhost/fsphp/fullstackphp/assets/php.png'/>",
"<img class='logofsphp' src='http://localhost/fsphp/fullstackphp/assets/php-logo.png'/>";
